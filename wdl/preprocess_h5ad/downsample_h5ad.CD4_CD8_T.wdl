    ...
    scatter (barcode_file in barcode_files) {
        ...
        call filter_CD4_CD8_T {
            input:
                ...
                barcode = flatten(pseudobulk_gex.out_barcode),
                docker = docker_suite,
                zones = zones
        }
        ...
        call filter_CD4_CD8_T as filter_CD4_CD8_T_atac {
            input:
        ...
        call tasks.combine_pseudobulk as combine_pseudobulk_atac {
            input:
                inv_bed = filter_CD4_CD8_T_atac.out_inv_bed,
                raw_bed = filter_CD4_CD8_T_atac.out_raw_bed,
                nonzero_prop = filter_CD4_CD8_T_atac.out_nonzero_prop,
                barcode = [filter_CD4_CD8_T_atac.out_barcode[0]],
                agg_method = "sum",
                docker = docker_suite,
                zones = zones
        }
